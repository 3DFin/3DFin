...
ttk.Label(frame1, image = logo_png).grid(column = 6, row = 1, rowspan = 2, columnspan = 2, sticky = ('N', 'S'))
...
"""
ttk.Separator(frame1, orient = 'VERTICAL').grid(column = 5, row = 1, rowspan = 9, sticky = ('N', 'S'))

ttk.Label(frame1, text = insert_text1).grid(column = 6, row = 3, rowspan = 7, columnspan = 2, sticky = ('N', 'W'))
...
infobutton11 = ttk.Label(frame1, image = info_icon)
...
infobutton12 = ttk.Label(frame1, image = info_icon)
...
infobutton13 = ttk.Label(frame1, image = info_icon)
...
infobutton14 = ttk.Label(frame1, image = info_icon)
...
infobutton15 = ttk.Label(frame1, image = info_icon)
...
infobutton16 = ttk.Label(frame1, image = info_icon)
...
bottom-left corner.
"""
ttk.Separator(frame2, orient = 'VERTICAL').grid(column = 5, row = 1, rowspan = 7, sticky = ('N', 'S'))

ttk.Label(frame2, text = "Advanced parameters", font = ("Helvetica", 10, "bold")).grid(column = 6, row = 1)
ttk.Label(frame2, text = insert_text2).grid(column = 6, row = 2, rowspan = 6, sticky = ('N', 'W'))
...
infobutton21 = ttk.Label(frame2, image = info_icon)
...
infobutton22 = ttk.Label(frame2, image = info_icon)
...
infobutton23 = ttk.Label(frame2, image = info_icon)
...
infobutton24 = ttk.Label(frame2, image = info_icon)
...
infobutton25 = ttk.Label(frame2, image = info_icon)
...
infobutton26 = ttk.Label(frame2, image = info_icon)
...
infobutton27 = ttk.Label(frame2, image = info_icon)
...
"""
ttk.Label(frame2, text = frame2_text).grid(column = 2, row = 10, columnspan = 5, sticky = ('N', 'W'))
...
ttk.Separator(frame3, orient = 'VERTICAL').grid(column = 5, row = 1, rowspan = 18, sticky = ('N', 'S'))
...
res_xy_stripe_info = ttk.Label(frame3, image = info_icon)
...
verticality_scale_stripe_info = ttk.Label(frame3, image = info_icon)
...
verticality_thresh_stripe_info = ttk.Label(frame3, image = info_icon)
...
epsilon_stripe_info = ttk.Label(frame3, image = info_icon)
...
verticality_scale_stems_info = ttk.Label(frame3, image = info_icon)
...
verticality_thresh_stems_info = ttk.Label(frame3, image = info_icon)
...
epsilon_stems_info = ttk.Label(frame3, image = info_icon)
...
height_range_info = ttk.Label(frame3, image = info_icon)
...
maximum_d_info = ttk.Label(frame3, image = info_icon)
...
res_heights_info = ttk.Label(frame3, image = info_icon)
...
maximum_dev_info = ttk.Label(frame3, image = info_icon)
...
section_wid_info = ttk.Label(frame3, image = info_icon)
...
number_points_section_info = ttk.Label(frame3, image = info_icon)
...
radius_proportion_info = ttk.Label(frame3, image = info_icon)
...
minimum_radius_info = ttk.Label(frame3, image = info_icon)
...
point_threshold_info = ttk.Label(frame3, image = info_icon)
...
point_distance_info = ttk.Label(frame3, image = info_icon)
...
number_sectors_info = ttk.Label(frame3, image = info_icon)
...
m_number_sectors_info = ttk.Label(frame3, image = info_icon)
...
circle_width_info = ttk.Label(frame3, image = info_icon)
...
axis_downstep_info = ttk.Label(frame3, image = info_icon)
...
if is_normalized:
    ...
    _, _, voxelated_ground = dm.voxelate(coords[coords[:, 3] < 0.5, 0:3], 1, 2000, n_digits, with_n_points = False)
    ...
    if is_noisy:
        ...
        cloth_nodes = dm.generate_dtm(clean_points, bSloopSmooth = True, cloth_resolution = 0.5, classify_threshold = 0.2)
        ...
        cloth_nodes = dm.generate_dtm(coords, bSloopSmooth = True, cloth_resolution = 0.5, classify_threshold = 0.2)
...
assigned_cloud, tree_vector, tree_heights = dm.individualize_trees(coords, clust_stripe, resolution_xy, resolution_z, d_max, h_range, min_points, d_heights, max_dev, filename_las, resolution_heights, tree_id_field = -1)     
...
for tr in trees: 
    ...
    for b in sections: 
        ...
        (X_c_fill, Y_c_fill, R_fill, check_circle_fill, second_time_fill, sector_perct_fill, n_points_in_fill) = dm.fit_circle_check(X, Y, 0, 0, times_R, threshold, R_min, R_max, max_dist, n_points_section, n_sectors, min_n_sectors, width)
